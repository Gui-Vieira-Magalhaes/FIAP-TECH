...
# Seleção do período para média móvel
st.subheader("Gráfico de Preços com Média Móvel e Eventos Históricos")
window_size = st.slider("Escolha o período para a média móvel (em dias):", 7, 365, 30)
data['Moving_Average'] = calculate_moving_average(data, window_size)

# Gráfico de preços com média móvel e eventos históricos
